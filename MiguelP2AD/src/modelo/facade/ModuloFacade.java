...
public class ModuloFacade {
    ...
    public static void marshal(ModulosVO modulos) {
        try {
            ...
            ms.marshal(modulos,new File("src/Ej2_AD_Modulo.xml"));
    ...
    public static ModulosVO unmarshal() {
        try {
            ...
            return (ModulosVO) ums.unmarshal(new File("src/Ej2_AD_Modulo.xml"));
        } catch (JAXBException e) {
    ...
    public static List<String[]>listarModulo() {
        ...
        ModulosVO modulos=unmarshal();
        if (modulos==null) {
            Logger.getLogger(ModulosController.class.getName()).log(Level.INFO,"No hay datos en el archivo 'Ej2_AD_Modulo.xml'");
